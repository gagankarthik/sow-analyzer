...
function FloatingNav() {
  ...
  return (
    <>
      <header className="fixed top-4 md:top-6 left-0 right-0 z-50 flex items-center justify-center px-4 w-full pointer-events-none">
        <div
          className="relative pointer-events-auto w-full max-w-[860px]"
        ...
        <motion.div
          ...
          className={[
            "flex items-center justify-between rounded-full pl-3 pr-3 py-2 border border-border h-[56px] bg-card/90 backdrop-blur-xl shadow-sm",
        ...
        >
              ...
              return (
                ...
                >
                  <Link
                    href={m.href}
                    className={[
                      "inline-flex items-center gap-1 h-9 px-3 rounded-full text-[13px] font-medium transition-colors",
                      isOpen
          ...
          <div className="flex items-center gap-1 shrink-0">
            <Link
              href="/dashboard"
              className="hidden lg:inline-flex items-center gap-1 px-3 h-9 text-muted-foreground hover:text-foreground text-[13px] font-medium transition-colors"
            >
              Open app <ArrowUpRight size={12} strokeWidth={2} />
            </Link>
            <Link
              href="/signup"
              className="hidden sm:inline-flex items-center gap-1 px-4 text-[13px] font-semibold h-9 rounded-full text-white bg-[var(--brand-primary-600)] hover:bg-[var(--brand-primary-700)] transition-colors duration-200 whitespace-nowrap shrink-0"
            >
              Book a demo
            ...
            <button
              ...
              className="lg:hidden inline-flex items-center justify-center h-9 w-9 rounded-full text-foreground hover:bg-muted transition-colors ml-1"
            >
        ...
        <nav className="overflow-y-auto h-[calc(100%-3.5rem)] px-2 py-4">
          ...
          <div className="border-t border-border mt-3 pt-3 px-3 space-y-2">
            <Link
              href="/dashboard"
              onClick={onClose}
              className="flex items-center justify-between h-11 px-4 rounded-md border border-border text-[13px] font-medium hover:bg-muted transition-colors"
            >
              Open the app
            ...
            <Link
              href="/signup"
              onClick={onClose}
              className="flex items-center justify-center gap-1 h-11 px-4 rounded-md text-white bg-[var(--brand-primary-600)] hover:bg-[var(--brand-primary-700)] text-[13px] font-semibold transition-colors"
            >
