        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <aside className="lg:col-span-4 space-y-5">
            <div className="rounded-xl border border-[var(--ai-border)] bg-[var(--ai-surface)]/60 p-5">
              <div className="flex items-center gap-2 mb-3"><BluelyMark size="sm" /><span className="text-[10.5px] font-semibold uppercase tracking-[0.14em] text-[var(--ai-ink)]">Bluely · activity read</span></div>
              <p className="text-[12.5px] leading-relaxed text-foreground">Ask Bluely to summarize how this contract has evolved and flag the inflection points that changed its risk.</p>
            </div>
